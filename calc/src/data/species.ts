...
const RBY: {[name: string]: SpeciesData} = {
  ...
  Ditto: {types: ['Sus', 'Liquid'], bs: {hp: 48, at: 48, df: 48, sp: 48, sl: 48}, weightkg: 4},
  Dodrio: {
  ...
  Flareon: {types: ['Fire', 'Fluffy'], bs: {hp: 65, at: 130, df: 60, sp: 65, sl: 110}, weightkg: 25},
  Gastly: {
    types: ['Ghost', 'Poison'],
  ...
  Kingler: {types: ['Crab'], bs: {hp: 55, at: 130, df: 115, sp: 75, sl: 50}, weightkg: 60},
  Koffing: {
    types: ['Poison', 'Stinky'],
  ...
  Muk: {types: ['Liquid', 'Poison'], bs: {hp: 105, at: 105, df: 75, sp: 50, sl: 65}, weightkg: 30},
  Nidoking: {
    types: ['Poison', 'Ground'],
  ...
  Seadra: {types: ['Water', 'Gun'], bs: {hp: 55, at: 65, df: 95, sp: 85, sl: 95}, weightkg: 25},
...
const GSC_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  // gen 2 pokemon
  Aipom: {types: ['Monke'], bs: {hp: 55, at: 70, df: 55, sa: 40, sd: 55, sp: 85}, weightkg: 11.5},
  Ampharos: {
    types: ['Electric'],
  ...
  Furret: {types: ['Friend', 'Fluffy'], bs: {hp: 85, at: 76, df: 64, sa: 45, sd: 55, sp: 90}, weightkg: 32.5},
  Girafarig: {
  ...
  Smeargle: {types: ['Type'], bs: {hp: 55, at: 20, df: 35, sa: 20, sd: 45, sp: 75}, weightkg: 58},
  Smoochum: {
    types: ['Ice', 'Psychic'],
  ...
  Umbreon: {types: ['Dark', 'Space'], bs: {hp: 95, at: 65, df: 110, sa: 60, sd: 130, sp: 65}, weightkg: 27},
  Unown: {
    types: ['Psychic'],
...
const XY_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Azumarill: {types: ['Water', 'Gender'], bs: {sa: 60}},
  Azurill: {types: ['Normal', 'Gender', 'Baby']},
  ...
  Clefable: {types: ['Space', 'Fairy'], bs: {sa: 95}},
  Clefairy: {types: ['Space', 'Fairy']},
  Cleffa: {types: ['Space', 'Fairy', 'Baby']},
  Cottonee: {types: ['Grass', 'Fairy']},
  Exploud: {bs: {sd: 73}},
  Gallade: {otherFormes: ['Gallade-Mega']},
  Garchomp: {otherFormes: ['Garchomp-Mega']},
  Gardevoir: {types: ['Space', 'Fairy', 'Gender'], otherFormes: ['Gardevoir-Mega']},
  Gengar: {otherFormes: ['Gengar-Mega']},
  Gigalith: {bs: {sd: 80}},
  Glalie: {otherFormes: ['Glalie-Mega']},
  Golem: {bs: {at: 120}},
  Granbull: {types: ['Boomer']},
