...
const RBY: {[name: string]: MoveData} = {
  ...
  Amnesia: {bp: 0, category: 'Status', type: 'Dream'},
  'Aurora Beam': {bp: 65, type: 'Ice'},
  Barrage: {bp: 15, type: 'Guys', multihit: [2, 5]},
  Bide: {bp: 0, type: '???'},
  ...
  Crabhammer: {bp: 90, type: 'Crab'},
  'Defense Curl': {bp: 0, category: 'Status', type: 'Ball'},
  Dig: {bp: 100, type: 'Ground'},
  Disable: {bp: 0, category: 'Status', type: 'Normal'},
  'Dizzy Punch': {bp: 70, type: 'Silly'},
  ...
  'Dragon Rage': {bp: 1, type: 'Angy'},
  'Dream Eater': {bp: 100, type: 'Dream', drain: [1, 2]},
  Earthquake: {bp: 100, type: 'Ground'},
  Explosion: {bp: 170, type: 'Bad'},
  ...
  'Fury Attack': {bp: 15, type: 'Guys', multihit: [2, 5]},
  'Fury Swipes': {bp: 18, type: 'Guys', multihit: [2, 5]},
  Glare: {bp: 0, category: 'Status', type: 'Normal'},
  Growth: {bp: 0, category: 'Status', type: 'Normal'},
  Guillotine: {bp: 0, type: 'Sharp'},
  ...
  'Hyper Beam': {bp: 150, type: 'Bad'},
  'Jump Kick': {bp: 70, type: 'Fighting', hasCrashDamage: true},
  'Karate Chop': {bp: 50, type: 'Normal'},
  'Leech Seed': {bp: 0, category: 'Status', type: 'Grass'},
  'Light Screen': {bp: 0, category: 'Status', type: 'Magic'},
  Metronome: {bp: 0, category: 'Status', type: 'Magic'},
  Mimic: {bp: 0, category: 'Status', type: 'Sus'},
  Minimize: {bp: 0, category: 'Status', type: 'Little'},
  'Mirror Move': {bp: 0, category: 'Status', type: 'Flying'},
  Mist: {bp: 0, category: 'Status', type: 'Ice'},
  'Night Shade': {bp: 1, type: 'Ghost'},
  'Petal Dance': {bp: 70, type: 'Dance'},
  'Pin Missile': {bp: 14, type: 'Sharp', multihit: [2, 5]},
  'Poison Sting': {bp: 15, type: 'Poison'},
  Psychic: {bp: 90, type: 'Psychic'},
  Psywave: {bp: 1, type: 'Psychic'},
  Rage: {bp: 20, type: 'Angy'},
  'Razor Leaf': {bp: 55, type: 'Grass'},
  'Razor Wind': {bp: 80, type: 'Sharp'},
  Recover: {bp: 0, category: 'Status', type: 'Normal'},
  Reflect: {bp: 0, category: 'Status', type: 'Magic'},
  Rest: {bp: 0, category: 'Status', type: 'Baby'},
  ...
  'Seismic Toss': {bp: 1, type: 'Space'},
  'Self-Destruct': {bp: 130, type: 'Bad'},
  'Skull Bash': {bp: 100, type: 'Normal'},
  Slash: {bp: 70, type: 'Sharp'},
  ...
  'Spike Cannon': {bp: 20, type: 'Sharp', multihit: [2, 5]},
  Stomp: {bp: 65, type: 'Normal'},
  Struggle: {bp: 50, type: 'Normal', recoil: [1, 2]},
  'Stun Spore': {bp: 0, category: 'Status', type: 'Grass'},
  Submission: {bp: 80, type: 'Smash', recoil: [1, 4]},
  Substitute: {bp: 0, category: 'Status', type: 'Normal'},
  'Super Fang': {bp: 1, type: 'Sharp'},
  Swift: {bp: 60, type: 'Space'},
  'Take Down': {bp: 90, type: 'Angy', recoil: [1, 4]},
  Thrash: {bp: 90, type: 'Angy'},
  Thunder: {bp: 120, type: 'Electric'},
  'Thunder Wave': {bp: 0, category: 'Status', type: 'Electric'},
  Transform: {bp: 0, category: 'Status', type: 'Sus'},
  'Tri Attack': {bp: 80, type: 'Gamer'},
  ...
  Leer: {bp: 0, category: 'Status', type: 'Ugly'},
  'Low Kick': {bp: 50, type: 'Fighting'},
  'Poison Gas': {bp: 0, category: 'Status', type: 'Stinky'},
  ...
  Toxic: {bp: 0, category: 'Status', type: 'Gamer'},
  Flash: {bp: 0, category: 'Status', type: 'Normal'},
  Hypnosis: {bp: 0, category: 'Status', type: 'Dream'},
  ...
  'Acid Armor': {bp: 0, category: 'Status', type: 'Liquid'},
  Barrier: {bp: 0, category: 'Status', type: 'Magic'},
  'Body Slam': {bp: 85, type: 'Bad'},
  Flamethrower: {bp: 95, type: 'Fire'},
  'Hydro Pump': {bp: 120, type: 'Water'},
  'Ice Beam': {bp: 95, type: 'OU'},
  Lick: {bp: 20, type: 'Sus'},
  Screech: {bp: 0, category: 'Status', type: 'Monke'},
  Sing: {bp: 0, category: 'Status', type: 'Song'},
  'Sleep Powder': {bp: 0, category: 'Status', type: 'Grass'},
  Smog: {bp: 20, type: 'Poison'},
  Spore: {bp: 0, category: 'Status', type: 'Grass'},
  Supersonic: {bp: 0, category: 'Status', type: 'Song'},
  'Swords Dance': {bp: 0, category: 'Status', type: 'Sharp'},
  Thunderbolt: {bp: 95, type: 'OU'},
  'Bone Club': {bp: 65, type: 'Ground'},
  'Egg Bomb': {bp: 100, type: 'Baby'},
  'Hyper Fang': {bp: 80, type: 'Normal'},
  Kinesis: {bp: 0, category: 'Status', type: 'Magic'},
  'Lovely Kiss': {bp: 0, category: 'Status', type: 'Ugly'},
  Meditate: {bp: 0, category: 'Status', type: 'Psychic'},
  'Rolling Kick': {bp: 60, type: 'Dance'},
  Sharpen: {bp: 0, category: 'Status', type: 'Sharp'},
...
const GSC_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Attract: {bp: 0, category: 'Status', type: 'Bad'},
  'Beat Up': {bp: 10, type: 'Guys'},
  'Belly Drum': {bp: 0, category: 'Status', type: 'Normal'},
  'Conversion 2': {bp: 0, category: 'Status', type: 'Normal2'},
  ...
  Encore: {bp: 0, category: 'Status', type: 'Guys'},
  Endure: {bp: 0, category: 'Status', type: 'Bad', priority: 2},
  Flail: {bp: 0, type: 'Ugly'},
  ...
  'Lock-On': {bp: 0, category: 'Status', type: 'Gun'},
  'Mind Reader': {bp: 0, category: 'Status', type: 'Normal'},
  'Mirror Coat': {bp: 0, type: 'Psychic'},
  Moonlight: {bp: 0, category: 'Status', type: 'Space'},
  'Morning Sun': {bp: 0, category: 'Status', type: 'Space'},
  Nightmare: {bp: 0, category: 'Status', type: 'Dream'},
  Outrage: {bp: 90, type: 'Angy'},
  'Powder Snow': {bp: 40, type: 'Ice'},
  Present: {bp: 0, type: 'Friend'},
  Protect: {bp: 0, category: 'Status', type: 'Gamer', priority: 2},
  ...
  Sandstorm: {bp: 0, category: 'Status', type: 'Gamer'},
  Sketch: {bp: 0, category: 'Status', type: 'Type'},
  'Sleep Talk': {bp: 0, category: 'Status', type: 'Baby'},
  Spikes: {bp: 0, category: 'Status', type: 'Sharp'},
  Spite: {bp: 0, category: 'Status', type: 'Ghost'},
  'Sunny Day': {bp: 0, category: 'Status', type: 'Space'},
  Swagger: {bp: 0, category: 'Status', type: 'Bad'},
  'Sweet Scent': {bp: 0, category: 'Status', type: 'Normal'},
  Synthesis: {bp: 0, category: 'Status', type: 'Grass'},
  Thief: {bp: 40, type: 'Sus'},
  'Triple Kick': {bp: 10, type: 'Fighting', multihit: [1, 3]},
  Twister: {bp: 40, type: 'Dragon'},
  'Ancient Power': {bp: 60, type: 'Ancient'},
  ...
  'Mean Look': {bp: 0, category: 'Status', type: 'Angy'},
  ...
  'Cotton Spore': {bp: 0, category: 'Status', type: 'Fluffy'},
  'Extreme Speed': {bp: 80, type: 'Normal', priority: 1},
  'Fury Cutter': {bp: 10, type: 'Bug'},
  Magnitude: {bp: 0, type: 'Ground'},
  'Milk Drink': {bp: 0, category: 'Status', type: 'Liquid'},
  'Scary Face': {bp: 0, category: 'Status', type: 'Ugly'},
  Charm: {bp: 0, category: 'Status', type: 'Baby'},
  ...
  'Perish Song': {bp: 0, category: 'Status', type: 'Song'},
  Snore: {bp: 40, type: 'Baby'},
  'Sweet Kiss': {bp: 0, category: 'Status', type: 'Guys'},
  Rollout: {bp: 30, type: 'Ball'},
  Frustration: {bp: 0, type: 'Angy'},
  Return: {bp: 0, type: 'Friend'},
  ...
  'Pain Split': {bp: 0, category: 'Status', type: 'Ugly'},
...
const ADV_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Assist: {bp: 0, category: 'Status', type: 'Friend'},
  ...
  'Magic Coat': {bp: 0, category: 'Status', type: 'Magic', priority: 4},
  ...
  'Odor Sleuth': {bp: 0, category: 'Status', type: 'Stinky'},
  Overheat: {bp: 140, type: 'Fire', self: {boosts: {spa: -2}}, makesContact: true},
  Revenge: {bp: 60, type: 'Ugly', makesContact: true},
  'Rock Blast': {bp: 25, type: 'Rock', multihit: [2, 5]},
  'Role Play': {bp: 0, category: 'Status', type: 'Sus'},
  ...
  'Teeter Dance': {bp: 0, category: 'Status', type: 'Dance', target: 'allAdjacent'},
  Tickle: {bp: 0, category: 'Status', type: 'Silly'},
  Trick: {bp: 0, category: 'Status', type: 'Sus'},
  Uproar: {bp: 50, type: 'Baby', isSound: true},
  ...
  Wish: {bp: 0, category: 'Status', type: 'Space'},
  'Air Cutter': {bp: 55, type: 'Flying', target: 'allAdjacentFoes'},
  Facade: {bp: 70, type: 'Sus', makesContact: true},
  'Grass Whistle': {bp: 0, category: 'Status', type: 'Song', isSound: true},
  ...
  'Meteor Mash': {bp: 100, type: 'Space', makesContact: true},
  ...
  'Ice Ball': {bp: 30, type: 'Ball', makesContact: true},
  'Sheer Cold': {bp: 0, type: 'Ice'},
  Howl: {bp: 0, category: 'Status', type: 'Angy'},
  ...
  'Calm Mind': {bp: 0, category: 'Status', type: 'Vibe'},
  'Cosmic Power': {bp: 0, category: 'Status', type: 'Space'},
  'Crush Claw': {bp: 75, type: 'Crab', makesContact: true},
  'Dragon Claw': {bp: 80, type: 'Dragon', makesContact: true},
  'Dragon Dance': {bp: 0, category: 'Status', type: 'Dance'},
  Eruption: {bp: 150, type: 'Fire', target: 'allAdjacentFoes'},
  'Fake Tears': {bp: 0, category: 'Status', type: 'Baby'},
  'Feather Dance': {bp: 0, category: 'Status', type: 'Dance'},
  Flatter: {bp: 0, category: 'Status', type: 'Furry'},
  ...
  Yawn: {bp: 0, category: 'Status', type: 'Baby'},
};
...
const DPP_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Chatter: {bp: 60, type: 'Song', isSound: true, category: 'Special'},
  Copycat: {bp: 0, type: 'Sus'},
  'Crush Grip': {
    bp: 0,
    type: 'Normal',
    makesContact: true,
  ...
  Fling: {bp: 0, type: 'Dark', category: 'Monke'},
  Gravity: {bp: 0, type: 'Space'},
  'Head Smash': {
    bp: 150,
    type: 'Rock',
    recoil: [1, 2],
  ...
  'Lucky Chant': {bp: 0, type: 'Vibe'},
  'Lunar Dance': {bp: 0, type: 'Space'},
  ...
  'Aura Sphere': {bp: 90, type: 'Gun', category: 'Special'},
  'Bug Buzz': {bp: 90, type: 'Bug', isSound: true, category: 'Special'},
  'Draco Meteor': {bp: 140, type: 'Space', self: {boosts: {spa: -2}}, category: 'Special'},
  ...
  'Gunk Shot': {bp: 120, type: 'Stinky', category: 'Physical'},
  'Gyro Ball': {
    bp: 0,
    type: 'Steel',
    makesContact: true,
  ...
  'Power Gem': {bp: 70, type: 'Gun', category: 'Special'},
  ...
  'Dark Void': {bp: 0, type: 'Dream', target: 'allAdjacentFoes'},
  ...
  'Roar of Time': {bp: 150, type: 'Ancient', category: 'Special'},
  'Rock Climb': {
    bp: 90,
    type: 'Normal',
    makesContact: true,
  ...
  'Spacial Rend': {bp: 100, type: 'Space', category: 'Special'},
  'Trump Card': {
    bp: 0,
    type: 'Right',
    makesContact: true,
...
const BW_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Fury Cutter': {bp: 20},
  'Future Sight': {bp: 100, type: 'Boomer'},
  'Giga Drain': {bp: 75},
  ...
  'Echoed Voice': {bp: 40, type: 'Song', isSound: true, category: 'Special'},
  ...
  Round: {bp: 60, type: 'Song', isSound: true, category: 'Special'},
  'Sacred Sword': {
    bp: 90,
    type: 'Fighting',
    makesContact: true,
  ...
  'Clear Smog': {bp: 50, type: 'Zoomer', category: 'Special'},
...
const XY_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Baby-Doll Eyes': {bp: 0, type: 'Baby', priority: 1},
  Belch: {bp: 120, type: 'Stinky', category: 'Special'},
  Boomburst: {
    bp: 140,
    type: 'Song',
    isSound: true,
  ...
  'Dazzling Gleam': {bp: 80, type: 'Gender', target: 'allAdjacentFoes', category: 'Special'},
  'Disarming Voice': {
    bp: 40,
    type: 'Song',
    isSound: true,
...
const SM_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Revelation Dance': {bp: 90, type: 'Dance', category: 'Special', zp: 175},
  ...
  'Moongeist Beam': {bp: 100, type: 'Space', category: 'Special', zp: 180},
  'Photon Geyser': {
    bp: 100,
    type: 'Psychic',
    category: 'Special',
...
const SS_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Clangorous Soul': {bp: 0, type: 'Song', isSound: true},
  'Coaching': {
    bp: 0,
    type: 'Fighting',
    category: 'Status',
...
const TMT_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  '5 Nights': {
    bp: 250,
    type: 'Gamer',
    category: 'Special',
...
const TMT: {[name: string]: MoveData} = extend(true, {}, SV, TMT_PATCH);

export const MOVES = [{}, RBY, GSC, ADV, DPP, BW, XY, SM, SS, SV, TMT];
